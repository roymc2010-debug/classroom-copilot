...
PROVIDERS = {
    ...
    "openrouter": {
        ...
        "model": "openrouter/auto"  # O "meta-llama/llama-3.3-70b-instruct:free"
    },
    "openai": {
...
async def ask_copilot(
    ...
    **kwargs
    ...
    # Soporte por si se pasa como provider_name
    ...
    try:
        ...
        return f"Error conectando con {provider_name}: {str(e)}"import os
from openai import AsyncOpenAI
from dotenv import load_dotenv
